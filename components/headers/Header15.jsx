        ...
        <div className="row wrapper-header align-items-center">
            ...
            <div className="d-xl-flex align-items-xl-center gap-xl-60">
              ...
              <div className="d-none d-xl-block">
                <nav className="box-navigation text-center">
                  <ul className="box-nav-ul main-menu d-flex align-items-center justify-content-center">
                    <Nav />
                  </ul>
                </nav>
              </div>
          ...
          <div className="col-xl-4 col-md-4 col-3">
            <div className="d-flex justify-content-end align-items-center gap-16 gap-xl-24">
              <form
                ref={searchRef}
                className="form-search d-xl-flex d-none position-relative"
