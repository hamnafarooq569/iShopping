...
import { useLogout, useUser } from "@/app/hooks/useAuth";
...
export default function AccountSidebar() {
  ...
  return (
    <div className="wrap-sidebar-account">
      {userLoading ? (
        <div><Skeleton width={300} height={400}/></div>
      ):user? (
        ...
        <div className="account-avatar">
          ...
          <h6 className="mb_4">{user.name}</h6>
        ...
        <ul className="my-account-nav">
          ...
          <li>
           <button onClick={handleLogout} className="my-account-nav-item">
