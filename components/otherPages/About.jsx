        ...
        <div className="row">
          <div className="col-md-6">
            <div className="about-us-features wow fadeInLeft">
              <Image
                className="lazyload"
                data-src="/ishop-assets/iphone-new1.png"
                alt="image-team"
                src="/ishop-assets/iphone-new1.png"
                width={30}
                height={18}
              />
            </div>
          ...
          <div className="col-md-6">
            <div className="about-us-content">
              <h3 className="title wow fadeInUp">
                Ishop – Offering effificent and top quality items worldwide
              </h3>
              <div className="widget-tabs style-3">
                ...
                <div className="widget-content-tab wow fadeInUp">
                  ...
                  >
                    <p>
                      Welcome to Ishop Store, your premier destination for
                      accessories. We pride
                      ...
                      styles and quality, ensuring every piece reflects quality and
